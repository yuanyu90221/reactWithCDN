...
class Timer extends React.Component {
    ...
    render() {
        return React.createElement(
            'div',
            { onClick: this.changeStatus.bind(this), className: this.state.stateColor },
            React.createElement(
                'h1',
                null,
...
ReactDOM.render(React.createElement(Timer, { workingTime: 25, restingTime: 5 }), document.getElementById('root'));